...
<div class="container-fluid">
	...
	<p>Internship Title: <b><large><?php echo ucwords($job_title) ?></large></b></p>
	<p>Location: <i class="fa fa-map-marker"></i> <b><large><?php echo $company ?></large></b></p>
	<p>Openings: <b><large><?php echo ucwords($openings) ?></large></b></p>
	<p>Apply Before: <b><large><?php echo ucwords($apply_before) ?></large></b></p>
